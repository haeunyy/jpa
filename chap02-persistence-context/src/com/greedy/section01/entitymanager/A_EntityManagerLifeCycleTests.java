...
public class A_EntityManagerLifeCycleTests {
    ...
    * */
	// 스레드세이프 : 여러 스레드 요청이 들어와도 순서가 꼬이지 않는 것. 
	...
	public void initManager() {
	 ...
	 public void 엔터티_매니저_팩토리와_엔터티_매니저_생명주기_확인1() {
		 System.out.println("entityManagerFactory.hashCode : " + entityManagerFactory.hashCode()); // 스레드 세이프 
		 System.out.println("entityManager.hashCode : " + entityManager.hashCode()); // 요청 단위당 새롭게 만들어져야하는 객체, 스레드 세이프 하지 않다. 
	 }
